...
if __name__ == "__main__":
    ...
    proximity = jsonconfig['DUT']['Proximity']
    apts = jsonconfig['DUT']['APTS']
    trigger_threshold = jsonconfig['DUT']['Trigger_threshold']
    daq_serial = jsonconfig['DUT']['DAQ_serial']    
    nevents = jsonconfig['DUT']['Events']
